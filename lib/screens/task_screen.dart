...
import 'package:project1/provider/notification_provider.dart';
import 'package:project1/styles/global_values.dart';
import 'package:project1/widgets/TaskWidget.dart';
                ...
                if (res.isEmpty) {
                  ArtSweetAlert.show(
                      ...
                      artDialogArgs: ArtDialogArgs(
                          ...
                          title: "¡Error!",
                          text:
                              "At least one teacher must be registered to add tasks"));
                } else {
